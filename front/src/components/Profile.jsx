              ...
              <div className="center_container">
                <div className="profile-header">
                  <div className="skyblue-section">
                    <img
                      src="img/WhatsApp Image 2023-07-03 at 21.00.23.jpeg"
                      alt="Profile Avatar"
                      className="avatar"
                    />
                  </div>
                    ...
                    <div className="card_interior_right">
                      ...
                      <div className="text_card">
                        <p>
                          ...
                          elit. Distinctio, ipsum nemo ipsam dolore molestiae
                          architecto accusamus optio molestias neque officia,
                          labore rem laboriosam cum placeat, veniam a at sint
                          velit ad! Voluptatum mollitia a fugit tempore, vitae
                          itaque eligendi laboriosam ab cumque voluptate natus
                          quis totam, alias facilis laborum rem.
                        </p>
                      </div>
